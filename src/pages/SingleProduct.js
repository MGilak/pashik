  ...
  return (
    <div ref={scrollRef}>
      ...
      {product.title ? (
            ...
            <div className="product__info">
              ...
              <div className="product__info__2">
                ...
                <div className="sub__title">
                  ...
                  <div className="product__info__price">
                    <span
                      dir="rtl"
                      className="product__info__price__amount alone"
                    >
              ...
              <div className="product__info__3">
                <div className="sub__title colors">
                  ...
                  <span className="color_name">
                    {product.colors[colorHover] || product.colors[colorIndex]}
                  </span>
                  <div className="product__colors">
                    {images.map((image, index) => (
                      <div className="product__colors__item">
                        <div
                          onMouseOver={() => setColorHover(index)}
                          onMouseLeave={() => setColorHover(null)}
                          onClick={() => {
                            setColorIndex(index);
                            setSizeColor((prev) => ({ ...prev, color: true }));
                          }}
                          className="product__colors__image"
                        >
                  ...
                  <div className="product__sizes">
                    {sizes.map((size, index) => (
                      <button
                        ...
                        className={`product__sizes__item ${
                          sizeColor.sizeId === size && "selected"
                        }`}
                      >
                        <span>{size}</span>
                      </button>
              ...
              <div className="product__info__4">
                ...
                <button onClick={addProductHandler} className="orange__button">
                  <span className="orange__button__text">
                    افزودن به سبد خرید
                  </span>
                  <span>
                    <svg
          ...
          <div className={`side__cart ${openSide && "open"}`}>
            <div className="side__cart__header">
              <span>
                <svg
                  ...
                  height="24.811"
                  viewBox="0 0 21.722 24.811"
                  class="side__cart__header__icon"
                  data-v-6d4a5be0=""
                >
                  <g
                    id="Union_3"
            ...
            <div className="side__cart__items__container">
              <div className="side__cart__items">
                {cart.map((item) => (
                  <div
                    className={`side__cart__item ${openSide && "showCartItem"}`}
                  >
            ...
            <div className="side__cart__buttons">
              ...
              <Link to="/cart" class="side__cart__buttons__cart">
                {" "}
                مشاهده سبد خرید{" "}
              </Link>
            </div>
        ...
        <h3 className="center">هیچ آیتمی برای نمایش وجود ندارد.</h3>
      )}
